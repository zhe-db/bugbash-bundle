...
Opening a pull request will trigger a[workflow](../.github/workflows/zhe-bugbash-run-tests-fs.yml) 
...
* [Staging workspace registered model](https://adb-5506808866566678.8.dev.azuredatabricks.net#mlflow/models/staging-zhe-bugbash-model)
* [Prod workspace registered model](https://adb-3885505072560999.9.dev.azuredatabricks.net#mlflow/models/prod-zhe-bugbash-model)
